<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="index.php" id="nav-link-assign" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Assign</a>
            ...
            <a href="console.php" id='nav-link-console' class="nav-item nav-link"><i class="fa fa-th me-2"></i>Console</a>
            <a href="history.php" id='nav-link-history' class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>History</a>
            <a href="signout.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Sign Out</a>
            <!--<div class="nav-item dropdown">
